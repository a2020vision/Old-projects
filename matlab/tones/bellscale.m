...
C=tone(half,-9,Fs).*belldy(half,Fs);
D=tone(half,-7,Fs).*belldy(half,Fs);
E=tone(half,-5,Fs).*belldy(half,Fs);
F=tone(half,-4,Fs).*belldy(half,Fs);
G=tone(half,-2,Fs).*belldy(half,Fs);
A=tone(half,0,Fs).*belldy(half,Fs);
B=tone(half,2,Fs).*belldy(half,Fs);
C2=tone(half,3,Fs).*belldy(half,Fs);
