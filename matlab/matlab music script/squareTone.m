function Y=squareTone(time,pitch,Fs,A)
...
if nargin < 4
	...
	A = 1/sqrt(2); % less than 1 so that it does not overpower sine-tones, or the user's ears
    ...
    if nargin < 3
        ...
        if nargin < 2
            disp('Function squareTone() was not passed enough arguments! It needs at least time and pitch.');
            return
        end
    end
end
