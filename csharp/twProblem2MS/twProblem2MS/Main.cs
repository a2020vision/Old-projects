...
class Program
{
    static void Main(string[] args)
    {
        ...
        if (args.Length == 0) { // in the case that no input file was supplied on the command line...
        ...
        using (StreamReader sr = new StreamReader(fileName))
        {
            while ((item = sr.ReadLine()) != null)
            {
                ...
                // [num items, int] [item description, string] at [item price, dec]
        ...
        // Final line was included for testing, to prevent terminal from closing before I could read the output
        // Console.ReadLine();
    }
}
